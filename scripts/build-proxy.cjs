#!/usr/bin/env node
/**
 * Build SpoofDPI 1.2.1 (beni-iceri-al-DPI-proxy) and copy to spoofdpi/ and src-tauri/binaries/.
 * Requires Go in PATH.
 */
...
const outExe = path.join(root, 'spoofdpi', 'beni-iceri-al-DPI-proxy.exe');
...
console.log('Building SpoofDPI (beni-iceri-al-DPI-proxy) with release flags...');
